...
class EmAySee_DeepReasoningConnectorWithSeed:
    def __init__(self):
        pass
    ...
    def execute_request(self, prompt, system_prompt, api_url, api_key, model_name, seed,
...
NODE_CLASS_MAPPINGS = {
    "EmAySee_DeepReasoningConnectorWithSeed": EmAySee_DeepReasoningConnectorWithSeed
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "EmAySee_DeepReasoningConnectorWithSeed": "EmAySee Deep Reasoning Connector"
}