...
class EmAySee_SubmitToOobaboogaAPI:  # Class name now prefixed with EmAySee_
    def __init__(self):
        pass
    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                ...
                "api_endpoint": ("STRING", {"default": "http://127.0.0.1:5000/v1/completions"}),  # Default oobabooga COMPletions API endpoint - Non-streaming
                ...
                "max_new_tokens": (
                    ["50", "100", "150", "200", "250", "300", "350", "400", "450", "500", "550", "600", "650", "700", "750", "800"],  # Dropdown options
    ...
    def submitToOobabooga(self, api_endpoint, text_input, temperature, top_p, top_k, typical_p, repetition_penalty, max_new_tokens, seed, delay_seconds, show_api_response, **kwargs): # Removed history_, added seed
        """
...
NODE_CLASS_MAPPINGS = {
    "EmAySee_SubmitToOobaboogaAPI": EmAySee_SubmitToOobaboogaAPI  # Class mapping with alias
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "EmAySee_SubmitToOobaboogaAPI": "EmAySee Submit to Oobabooga API Node" # Display name with alias
}